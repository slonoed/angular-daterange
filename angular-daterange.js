    ...
    .directive('daterange', [function() {
        ...
        var DateRangePicker = function(element, options, cb) {
            ...
            if (this.element.is('input')) {
                this.element.on({
                    click: angular.bind(this, this.show),
                    focus: angular.bind(this, this.show)
                });
            } else {
                this.element.on('click', angular.bind(this, this.show));
            }

            if (hasOptions) {
                if (typeof options.locale == 'object') {
                    angular.forEach(localeObject, function(value, property) {
            ...
            angular.forEach(this.buttonClasses, function(val, idx) {
            ...
            //event listeners
            this.container.on('mousedown', angular.bind(this, this.mousedown));
            this.container.find('.calendar').on('click', '.prev', angular.bind(this, this.clickPrev, this));
            this.container.find('.calendar').on('click', '.next', angular.bind(this, this.clickNext));
            this.container.find('.ranges').on('click', 'button.applyBtn', angular.bind(this, this.clickApply));
            this.container.find('.ranges').on('click', 'button.clearBtn', angular.bind(this, this.clickClear));

            this.container.find('.calendar').on('click', 'td.available', angular.bind(this, this.clickDate));
            this.container.find('.calendar').on('mouseenter', 'td.available', angular.bind(this, this.enterDate));
            this.container.find('.calendar').on('mouseleave', 'td.available', angular.bind(this, this.updateView));

            this.container.find('.ranges').on('click', 'li', angular.bind(this, this.clickRange));
            this.container.find('.ranges').on('mouseenter', 'li', angular.bind(this, this.enterRange));
            this.container.find('.ranges').on('mouseleave', 'li', angular.bind(this, this.updateView));

            this.container.find('.calendar').on('change', 'select.yearselect', angular.bind(this, this.updateYear));
            this.container.find('.calendar').on('change', 'select.monthselect', angular.bind(this, this.updateMonth));

            this.element.on('keyup', angular.bind(this, this.updateFromControl));
        ...
        DateRangePicker.prototype = {
            ...
            show: function(e) {
                ...
                $(document).on('mousedown', angular.bind(this, this.hide));
            },
            ...
            renderCalendar: function(calendar, selected, minDate, maxDate) {
                ...
                angular.forEach(this.locale.daysOfWeek, function(dayOfWeek, index) {
        ...
        return {
            ...
            template2: '<div><input type="text"/>\n\n    <div class="daterangepicker dropdown-menu">\n        <div class="calendar left"></div>\n        <div class="calendar right"></div>\n        <div class="ranges">\n            <div class="range_inputs">\n                <div class="daterangepicker_start_input" style="float: left"><label for="daterangepicker_start">{{locale.fromLabel}}</label><input\n                        class="input-mini" type="text" name="daterangepicker_start" value="" disabled="disabled"/></div>\n                <div class="daterangepicker_end_input" style="float: left; padding-left: 11px"><label\n                        for="daterangepicker_end">{{locale.toLabel}}</label><input class="input-mini" type="text"\n                                                                                   name="daterangepicker_end" value=""\n                                                                                   disabled="disabled"/></div>\n                <button class="{{css.applyClass}} applyBtn" disabled="disabled">{{locale.applyLabel}}</button>\n                &nbsp;\n                <button class="{{css.clearClass}} clearBtn">{{locale.clearLabel}}</button>\n            </div>\n        </div>\n    </div>\n</div>',
            template: '<input type="text" name="reservation" id="reservation" value="03/18/2013 - 03/23/2013" />',
            link: function(scope, element, attrs) {
                ...
                scope.css = {};
                scope.css.applyClass = 'btn btn-small btn-success';
                scope.css.clearClass = 'btn btn-small';
